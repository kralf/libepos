...
#define EPOS_POSITION_PROFILE_PARAMETER_POSITION      "POSITION"
#define EPOS_POSITION_PROFILE_PARAMETER_VELOCITY      "VELOCITY"
#define EPOS_POSITION_PROFILE_PARAMETER_ACCELERATION  "ACCELERATION"
#define EPOS_POSITION_PROFILE_PARAMETER_DECELERATION  "DECELERATION"
...
config_param_t epos_position_profile_default_arguments_params[] = {
  {EPOS_POSITION_PROFILE_PARAMETER_POSITION,
    config_param_type_float,
    "",
    "(-inf, inf)",
    "The demanded angular position in [deg]"},
  {EPOS_POSITION_PROFILE_PARAMETER_VELOCITY,
    config_param_type_float,
    "",
    "(-inf, inf)",
    "The demanded maximum angular velocity in [deg/s]"},
  {EPOS_POSITION_PROFILE_PARAMETER_ACCELERATION,
    config_param_type_float,
    "",
    "[0.0, inf)",
    "The demanded maximum angular acceleration in [deg/s^2]"},
  {EPOS_POSITION_PROFILE_PARAMETER_DECELERATION,
    config_param_type_float,
    "",
    "[0.0, inf)",
...
const config_default_t epos_position_profile_default_arguments = {
  epos_position_profile_default_arguments_params,
  sizeof(epos_position_profile_default_arguments_params)/
...
int main(int argc, char **argv) {
  ...
  config_parser_init_default(&parser,
    &epos_position_profile_default_arguments, 0,
    "Start EPOS controller in profile position mode",
    "Establish the communication with a connected EPOS device and attempt to "
    "start the controller in profile position mode. The controller will be "
