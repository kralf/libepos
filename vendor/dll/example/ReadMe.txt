========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : Demo_WinDLL
========================================================================


Diese Demo_WinDLL-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
Ihre Demo_WinDLL-Anwendung bilden.
...
Demo_WinDLL.h
	...
	Anwendungsklasse CDemo_WinDLLApp.
...
res\Demo_WinDLL.ico
	...
	Symbol wird durch die Haupt-Ressourcendatei Demo_WinDLL.rc eingebunden.
...
Demo_WinDLLDlg.h, Demo_WinDLLDlg.cpp - das Dialogfeld
    	Diese Dateien enthalten die Klasse CDemo_WinDLLDlg. Diese Klasse legt das
    	Verhalten des Haupt-Dialogfelds der Anwendung fest. Die Vorlage des Dialog-
	felds befindet sich in Demo_WinDLL.rc, die mit Microsoft Visual C++
...
StdAfx.h, StdAfx.cpp
	...
	Demo_WinDLL.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
